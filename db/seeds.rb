...
wro2=WorkoutRoutineObj.create(workout:workout6, routine:routine2, reps:20)
wro3=WorkoutRoutineObj.create(workout:workout2, routine:routine3, reps:3)
wro4=WorkoutRoutineObj.create(workout:workout9, routine:routine1, reps:10)
wro5=WorkoutRoutineObj.create(workout:workout10, routine:routine2, reps:12)
wro6=WorkoutRoutineObj.create(workout:workout1, routine:routine3, reps:8)
wro7=WorkoutRoutineObj.create(workout:workout3, routine:routine2, reps:10)
